...
//观察者从备库读取数据 用于获取最初的状态和库表结构然后跟踪进度和变更日志
//观察者
...
func (this *Inspector) InitDBConnections() (err error) {
	...
	// root:root@tcp(127.0.0.1:3307)/information_schema?interpolateParams=true&autocommit=true&charset=utf8mb4,utf8,latin1&tls=false
	...
	if !this.migrationContext.AliyunRDS && !this.migrationContext.GoogleCloudPlatform {
		if impliedKey, err := mysql.GetInstanceKey(this.db); err != nil {
			...
			this.connectionConfig.ImpliedKey = impliedKey // hostnane + port
		}
	}
	// 检查权限
